...
if not os.path.exists(db_name): 
    ...
    hrdb.create_customerdetails_table('C:/Users/joseph.behan/Local Projects - Temp/HR_DATA/sales_transactions.csv', conn)  # Update 'path_to_sales_transactions_csv' to the actual path
    hrdb.create_salesdetails_table('C:/Users/joseph.behan/Local Projects - Temp/HR_DATA/sales_transactions.csv', conn)  # Update 'path_to_sales_transactions_csv' to the actual path
    conn.commit()
    conn.close()
